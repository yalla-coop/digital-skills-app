  ...
  return (
    <>
      ...
      <Row>
        <Col w={[4, 12, 4]} mb="3">
          <HelpOut
            text={`Could you share some of the skills you've learned with others? We're on a mission to turn technophobes into digital whizzes and we need your help to make it happen`}
